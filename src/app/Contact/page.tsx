...
const page = () => {
  return (
    ...
    <div>
      <Navbar/>
      <section className="text-black bg-slate-300 body-font relative">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-semibold title-font mb-4 text-black">
        Contact Us
      </h1>
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-black border-0 py-2 px-8 focus:outline-none hover:bg-blue-900 rounded text-lg">
            Send Message
          </button>
        </div>
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a className="text-red-950">example@email.com</a>
          <span className="inline-flex">
            ...
            <a className="ml-4 text-blue-900">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <a className="ml-4 text-blue-950">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
    ...
    <div  className='py-96 relative top-40 right-14'>
